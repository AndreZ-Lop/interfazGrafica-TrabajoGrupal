...
public class Devolver extends Frame{
    public Devolver(){
        ...
        Label titulo = new Label("Devoluciones",Label.CENTER);
        Label mensaje = new Label("Que libro desea devolver",Label.CENTER);
        ...
        //botones
        Button salir = new Button("devolver");
