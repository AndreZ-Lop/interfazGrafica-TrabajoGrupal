...
public class RegistroAutor extends Frame{
        ...
        //Grid Layout
        GridLayout esquema1 = new GridLayout(6,2);
        ...
        Label idiom = new Label("La nacionalidad del autor: ",Label.CENTER);
       
        Label datosAutor = new Label("Ingrese el genero del autor ", Label.CENTER);
       
        
        Label user = new Label("REGISTRO AUTOR",Label.CENTER);
        //TEXT FIELDS
        ...
        TextField text8 = new TextField(15);
